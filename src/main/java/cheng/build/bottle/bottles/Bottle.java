...
import cheng.build.bottle.BottleExecute;
...
public abstract class Bottle extends Item implements IAnimatable {
    ...
    protected final BottleType fullBottleType;
    public Bottle(Properties pProperties, BottleType fullBottleType) {
        super(pProperties);
        this.fullBottleType = fullBottleType;
    }
    ...
    public BottleType getFullBottleType() {
        return this.fullBottleType;
    }

    public enum BottleType {
        EMPTY_MATTER_BOTTLE,
        SMASH_BOTTLE,
        INORGANIC_MATTER_BOTTLE,
        ORGANIC_MATTER_BOTTLE,
        AWAKENING_MATTER_BOTTLE
    }
}

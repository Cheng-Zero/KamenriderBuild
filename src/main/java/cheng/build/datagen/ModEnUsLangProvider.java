...
public class ModEnUsLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(InitMapping.ClearDriver.getName(),"Clear Driver");
        add(InitMapping.RotaryDriver.getName(),"Rotary Driver");
        ...
        add(InitItem.gorilla.get(),"Gorilla FullBottle");
        add(InitItem.tank.get(),"Tank FullBottle");
        add(InitItem.diamond.get(),"Diamond FullBottle");
